...
[cite_start]I am a Computer Science student at TMU [cite: 4, 5] [cite_start]with a background in **Cloud & AI Support**[cite: 7]. I specialize in building full-stack applications and integrating AI models to solve practical problems.

---

## 🚀 Featured Projects

### 🏋️‍♂️ [FitTrack - Full-Stack Fitness Tracker](https://fitness-pal--ArhamNauman.replit.app)
A digital fitness companion that allows users to log workouts, track health metrics, and visualize progress.
* **Tech Stack:** React 18 (TypeScript), Node.js, Express, PostgreSQL, Drizzle ORM, and Tailwind CSS.
